...
import jakarta.persistence.Column;
    ...
    public class Users {
         ...
         // IMPORTANT: Add this explicit no-argument constructor
    public Users() {
        // Default constructor required by JPA and Jackson for deserialization
    }
        @Id
        ...
        @JsonBackReference // Prevents recursive serialization of manager
        private Users manager;

        @OneToMany(mappedBy = "manager")
        @JsonManagedReference // Manages serialization of teamMembers
