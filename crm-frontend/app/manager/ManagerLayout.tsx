  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <div className="flex justify-between items-center h-16 sm:h-20">
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                ...
                <button
                  ...
                  className="group flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all duration-200 border border-blue-200/50 hover:border-blue-300 hover:shadow-md"
                >
                  ...
                  <span className="font-medium text-xs sm:text-sm hidden sm:block">Change Password</span>
                </button>
                <button
                  onClick={handleLogout}
                  className="group flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 rounded-xl transition-all duration-200 border border-red-200/50 hover:border-red-300 hover:shadow-md"
                >
                  <svg className="w-4 h-4 transition-transform duration-200 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isPasswordModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50Makesure flex items-center justify-center z-50 p-4">
